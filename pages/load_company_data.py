...
from util import render_load_company_data_sidebar, apply_custom_style, add_logo, get_logo_url, get_logo_path, style_metric_cards, fetch_supplier_names
...
render_load_company_data_sidebar()
menu_with_redirect()
